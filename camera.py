...
# ============================================================
# FRAME PROCESSOR (used for BROWSER webcam - works on Render!)
# ============================================================
class FrameProcessor:
    """Processes individual frames from the browser webcam.
    This does NOT need cv2.VideoCapture — frames come from the browser.
    """
    def __init__(self):
